...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2015 at 08:26 PM
...
INSERT INTO `admin` (`a_id`, `a_emri`, `a_email`, `a_pozicioni`, `a_cel`, `a_pas`, `a_gjinia`, `a_foto`, `a_adr`, `a_ws`) VALUES
(1, 'Medin', 'Piranej', 'Administrator', '0674654868', 'paskot', 1, 'img/def_profile_pic.jpg', 'mushan,dajç,shkoder,shqiperi', 'medin-piranej.tk');
...
--
-- Table structure for table `leje`
--

CREATE TABLE IF NOT EXISTS `leje` (
  `l_id` int(11) NOT NULL AUTO_INCREMENT,
  `l_prej` int(11) NOT NULL,
  `l_marresi` int(11) NOT NULL,
  `l_niveli` int(11) NOT NULL,
  PRIMARY KEY (`l_id`),
  KEY `l_prej` (`l_prej`),
  KEY `l_marresi` (`l_marresi`)
...
INSERT INTO `student` (`stud_id`, `s_emri`, `s_mbiemri`, `s_foto`, `s_dega`, `s_email`, `s_pas`, `s_cel`, `s_adr`, `s_cv`, `s_admin`, `s_tema`, `s_viti`, `s_data_fillimit`, `s_data_mbarimit`, `s_gjinia`, `s_ditelindja`, `s_privatesi`) VALUES
(1, 'Medin', 'Piranej', 'img/def_profile_pic.jpg', 1, 'mpiranej@gmail.com', 'paskot', '0674654868', 'mushan,dajc,shkoder,Shqiperi', 'cv_dir', 1, 1, 0, '2012-09-11', '2015-09-23', 1, '1994-02-07', 1),
(2, 'Bamirs', 'Bajraktari', 'img/def_profile_pic.jpg', 1, 'bamirsi@gmail.com', 'paskot', '-', 'shkoder,Shqiperi', 'cv dir', 1, 2, 0, '2012-09-11', '2015-09-23', 1, '1994-01-01', 2),
(3, 'Medina', 'Cura', 'img/def_profile_pic.jpg', 1, 'emailimedins@live.com', 'paskot', '-', '-', 'cv_dir', 1, 0, 0, '2015-03-09', '2015-03-11', 0, '1994-12-31', 3),
(4, 'Isuf', 'Peka', 'img/def_profile_pic.jpg', 1, 'isa123@live.com', 'paskot', '000000000', 'Krume , Has , Shqiperi', '-', 1, 2, 3, '2013-08-13', '2015-03-10', 1, '1991-03-20', 3),
(5, 'Mikel', 'Ara', 'img/def_profile_pic.jpg', 1, 'mara@gmail.com', 'paskot', '0000000000', 'Berdice , Shkoder ,Shqiperi', '-', 1, 0, 3, '2015-03-08', '2015-03-04', 1, '1994-06-24', 0),
(6, 'Bledar', 'Haxhia', 'img/def_profile_pic.jpg', 1, 'bledi@gmail.com', 'paskot', '00000000000', 'Rrile , Lezhe , Shqiperi', '-', 1, 0, 1, '2012-03-02', '2015-03-03', 1, '1993-03-24', 0);
